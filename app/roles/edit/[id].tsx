    ...
    <View style={styles.flex}>
      <ScrollView
        contentContainerStyle={[
          styles.container,
          // insets.bottom = device home bar height (0 on Android, ~34 on iPhone)
          // + 80 covers the tab bar sitting above it
      ...
      >
        ...
        {permissions.map((perm, index) => {
          ...
          const safeKey = !isNaN(idNum) ? idNum : `perm-${index}`;
...
const styles = StyleSheet.create({
  ...
  checkbox: {
    width: 22, height: 22,
    borderWidth: 1.5, borderColor: "#007AFF", borderRadius: 5,
